/**
* DECODE OpenGL32
* This file includes all the data for building the encoding functions.
* After sending the encoded data to the 3d clients, the encoding function
...
// GLCALLCONV void  glBitmap (GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, CGLubyteP bit);
...
IF_LOGGING(6)
unsigned size = ((unsigned)((width + 7) / 8)) * height;
LS << MAGIC << HEADERSIZE  + sizeof(GLsizei) + sizeof(GLsizei) + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLubyte) * size << ID_LOG << 6;
LSSB(&width,GLsizei); LSSB(&height,GLsizei); LSSB(&xorig,GLfloat); LSSB(&yorig,GLfloat); LSSB(&xmove,GLfloat); LSSB(&ymove,GLfloat);
for(unsigned i=0;i<size;i++) { LSSB(&bitmap[i],GLubyte); }
ENDLOG
...
IF_LOGGING(9)
unsigned typeSize = num_typesize(type); const GLbyte * l = (GLbyte*)lists;
LS << MAGIC << HEADERSIZE  + sizeof(GLsizei) + sizeof(GLenum) + typeSize * n << ID_LOG << 9;
LSSB(&n,GLsizei); LSSB(&type,GLenum);
if (type == GL_BYTE) {
	for(int i=0;i<n;i++) { LSSB(&l[i],GLbyte); }}
else if (type == GL_UNSIGNED_BYTE) {
	for(int i=0;i<n;i++) { LSSB((GLubyte*)&l[i],GLubyte); }}
else if (type == GL_SHORT) {
	for(int i=0;i<n;i++) { LSSB((GLshort*)&l[i],GLshort); }}
else if (type == GL_UNSIGNED_SHORT) {
	for(int i=0;i<n;i++) { LSSB((GLushort*)&l[i],GLushort); }}
else if (type == GL_INT) {
	for(int i=0;i<n;i++) { LSSB((GLint*)&l[i],GLint); }}
else if (type == GL_UNSIGNED_INT) {
	for(int i=0;i<n;i++) { LSSB((GLuint*)&l[i],GLuint); }}
else if (type == GL_FLOAT) {
	for(int i=0;i<n;i++) { LSSB((GLfloat*)&l[i],GLfloat); }}
else if (type == GL_2_BYTES) {
	for(int i=0;i<n*2;i++) { LSSB(&l[i],GLbyte); }}
else if (type == GL_3_BYTES) {
	for(int i=0;i<n*3;i++) { LSSB(&l[i],GLbyte); }}
else if (type == GL_4_BYTES) {
	for(int i=0;i<n*4;i++) { LSSB(&l[i],GLbyte); }}
ENDLOG
...
IF_LOGGING(16)
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLdouble) * 4 << ID_LOG << 16;
LSSB(&plane,GLenum); LSSB(&equation[0],GLdouble); LSSB(&equation[1],GLdouble); LSSB(&equation[2],GLdouble); LSSB(&equation[3],GLdouble); 
ENDLOG
...
IF_LOGGING(18)
LS << MAGIC << HEADERSIZE  + sizeof(GLbyte) + sizeof(GLbyte) + sizeof(GLbyte) << ID_LOG << 17;
LSSB(&v[0],GLbyte); LSSB(&v[1],GLbyte); LSSB(&v[2],GLbyte);
ENDLOG
...
IF_LOGGING(20)
LS << MAGIC << HEADERSIZE  + sizeof(GLdouble) + sizeof(GLdouble) + sizeof(GLdouble) << ID_LOG << 19;
LSSB(&v[0],GLdouble); LSSB(&v[1],GLdouble); LSSB(&v[2],GLdouble); 
ENDLOG
...
IF_LOGGING(22)
LS << MAGIC << HEADERSIZE  + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLfloat) << ID_LOG << 21;
LSSB(&v[0],GLfloat); LSSB(&v[1],GLfloat); LSSB(&v[2],GLfloat); 
ENDLOG
...
IF_LOGGING(24)
LS << MAGIC << HEADERSIZE  + sizeof(GLint) + sizeof(GLint) + sizeof(GLint) << ID_LOG << 23;
LSSB(&v[0],GLint); LSSB(&v[1],GLint); LSSB(&v[2],GLint); 
ENDLOG
...
IF_LOGGING(26)
LS << MAGIC << HEADERSIZE  + sizeof(GLshort) + sizeof(GLshort) + sizeof(GLshort) << ID_LOG << 25;
LSSB(&v[0],GLshort); LSSB(&v[1],GLshort); LSSB(&v[2],GLshort); 
ENDLOG
...
IF_LOGGING(28)
LS << MAGIC << HEADERSIZE  + sizeof(GLubyte) + sizeof(GLubyte) + sizeof(GLubyte) << ID_LOG << 27;
LSSB(&v[0],GLubyte); LSSB(&v[1],GLubyte); LSSB(&v[2],GLubyte);
ENDLOG
...
IF_LOGGING(30)
LS << MAGIC << HEADERSIZE  + sizeof(GLuint) + sizeof(GLuint) + sizeof(GLuint) << ID_LOG << 29;
LSSB(&v[0],GLuint); LSSB(&v[1],GLuint); LSSB(&v[2],GLuint); 
ENDLOG
...
IF_LOGGING(32)
LS << MAGIC << HEADERSIZE  + sizeof(GLushort) + sizeof(GLushort) + sizeof(GLushort) << ID_LOG << 31;
LSSB(&v[0],GLushort); LSSB(&v[1],GLushort); LSSB(&v[2],GLushort); 
ENDLOG
...
IF_LOGGING(34)
LS << MAGIC << HEADERSIZE  + sizeof(GLbyte) + sizeof(GLbyte) + sizeof(GLbyte) + sizeof(GLbyte) << ID_LOG << 33;
LSSB(&v[0],GLbyte); LSSB(&v[1],GLbyte); LSSB(&v[2],GLbyte); LSSB(&v[3],GLbyte); 
ENDLOG
...
IF_LOGGING(36)
LS << MAGIC << HEADERSIZE  + sizeof(GLdouble) + sizeof(GLdouble) + sizeof(GLdouble) + sizeof(GLdouble) << ID_LOG << 35;
LSSB(&v[0],GLdouble); LSSB(&v[1],GLdouble); LSSB(&v[2],GLdouble); LSSB(&v[3],GLdouble); 
ENDLOG
...
IF_LOGGING(38)
LS << MAGIC << HEADERSIZE  + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLfloat) << ID_LOG << 37;
LSSB(&v[0],GLfloat); LSSB(&v[1],GLfloat); LSSB(&v[2],GLfloat); LSSB(&v[3],GLfloat);
ENDLOG
...
IF_LOGGING(40)
LS << MAGIC << HEADERSIZE  + sizeof(GLint) + sizeof(GLint) + sizeof(GLint) + sizeof(GLint) << ID_LOG << 39;
LSSB(&v[0],GLint); LSSB(&v[1],GLint); LSSB(&v[2],GLint); LSSB(&v[3],GLint); 
ENDLOG
...
IF_LOGGING(42)
LS << MAGIC << HEADERSIZE  + sizeof(GLshort) + sizeof(GLshort) + sizeof(GLshort) + sizeof(GLshort) << ID_LOG << 41;
LSSB(&v[0],GLshort); LSSB(&v[1],GLshort); LSSB(&v[2],GLshort); LSSB(&v[3],GLshort);
ENDLOG
...
IF_LOGGING(44)
LS << MAGIC << HEADERSIZE  + sizeof(GLubyte) + sizeof(GLubyte) + sizeof(GLubyte) + sizeof(GLubyte) << ID_LOG << 43;
LSSB(&v[0],GLubyte); LSSB(&v[1],GLubyte); LSSB(&v[2],GLubyte); LSSB(&v[3],GLubyte); 
ENDLOG
...
IF_LOGGING(46)
LS << MAGIC << HEADERSIZE  + sizeof(GLuint) + sizeof(GLuint) + sizeof(GLuint) + sizeof(GLuint) << ID_LOG << 45;
LSSB(&v[0],GLuint); LSSB(&v[1],GLuint); LSSB(&v[2],GLuint); LSSB(&v[3],GLuint); 
ENDLOG
...
IF_LOGGING(48)
LS << MAGIC << HEADERSIZE  + sizeof(GLushort) + sizeof(GLushort) + sizeof(GLushort) + sizeof(GLushort) << ID_LOG << 47;
LSSB(&v[0],GLushort); LSSB(&v[1],GLushort); LSSB(&v[2],GLushort); LSSB(&v[3],GLushort);
ENDLOG
...
IF_LOGGING(68)
unsigned bytes = crImageSize(format, type, width, height); const GLbyte * bytePixels = (GLbyte*) pixels;
LS << MAGIC << HEADERSIZE  + sizeof(GLsizei) + sizeof(GLsizei) + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLbyte) * bytes << ID_LOG << 68;
LSSB(&width,GLsizei); LSSB(&height,GLsizei); LSSB(&format,GLenum); LSSB(&type,GLenum); 
for(unsigned i=0;i<bytes;i++) { LSSB(&bytePixels[i],GLbyte); }
ENDLOG
...
IF_LOGGING(81)
LS << MAGIC << HEADERSIZE  + sizeof(GLdouble) + sizeof(GLdouble) << ID_LOG << 80;
LSSB(&u[0],GLdouble); LSSB(&u[1],GLdouble); 
ENDLOG
...
IF_LOGGING(83)
LS << MAGIC << HEADERSIZE  + sizeof(GLfloat) + sizeof(GLfloat) << ID_LOG << 82;
LSSB(&u[0],GLfloat); LSSB(&u[1],GLfloat); 
ENDLOG
...
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLfloat) << ID_LOG << 91;
LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); }
else {
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLfloat) << ID_LOG << 92;
LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); LSSB(&params[1],GLfloat); LSSB(&params[2],GLfloat); LSSB(&params[3],GLfloat); }
ENDLOG
...
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLint) + sizeof(GLint) + sizeof(GLint) + sizeof(GLint) << ID_LOG << 94;
LSSB(&pname,GLenum); LSSB(&params[0],GLint); LSSB(&params[1],GLint); LSSB(&params[2],GLint); LSSB(&params[3],GLint); }
ENDLOG
...
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLfloat) * 4 << ID_LOG << 154;
LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); LSSB(&params[1],GLfloat); LSSB(&params[2],GLfloat); LSSB(&params[3],GLfloat); }
ENDLOG
...
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLint) * 4 << ID_LOG << 156;
LSSB(&pname,GLenum); LSSB(&params[0],GLint); LSSB(&params[1],GLint); LSSB(&params[2],GLint); LSSB(&params[3],GLint); }
ENDLOG
...
IF_LOGGING(158)
if (pname == GL_AMBIENT || pname == GL_DIFFUSE || pname == GL_SPECULAR || pname == GL_POSITION) { // four values
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLfloat) * 4 << ID_LOG << 158;
LSSB(&light,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); LSSB(&params[1],GLfloat); LSSB(&params[2],GLfloat); LSSB(&params[3],GLfloat); }
else if (pname == GL_SPOT_DIRECTION) { // three values 
GLfloat zero = 0;
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLfloat) * 4 << ID_LOG << 158;
LSSB(&light,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); LSSB(&params[1],GLfloat); LSSB(&params[2],GLfloat); LSSB(&zero,GLfloat); }
else { // one value
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLfloat) << ID_LOG << 157;
LSSB(&light,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); }
ENDLOG
...
IF_LOGGING(160)
if (pname == GL_AMBIENT || pname == GL_DIFFUSE || pname == GL_SPECULAR || pname == GL_POSITION) { // four values
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLint) * 4 << ID_LOG << 160;
LSSB(&light,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLint); LSSB(&params[1],GLint); LSSB(&params[2],GLint); LSSB(&params[3],GLint); }
else if (pname == GL_SPOT_DIRECTION) { // three values 
GLint zero = 0;
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLint) * 4 << ID_LOG << 160;
LSSB(&light,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLint); LSSB(&params[1],GLint); LSSB(&params[2],GLint); LSSB(&zero,GLint); }
else { // one value
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLint) << ID_LOG << 159;
LSSB(&light,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLint); }
ENDLOG
...
IF_LOGGING(165)
LS << MAGIC << HEADERSIZE  + sizeof(GLdouble) * 16 << ID_LOG << 165;
for(int i=0;i<16;i++) { LSSB(&m[i],GLdouble); }
ENDLOG
...
IF_LOGGING(166)
LS << MAGIC << HEADERSIZE  + sizeof(GLfloat) * 16 << ID_LOG << 166;
for(int i=0;i<16;i++) { LSSB(&m[i],GLfloat); }
ENDLOG
...
IF_LOGGING(169)
unsigned numValues = map_num_components(target); const GLdouble *src = points; //is modified stride now!!
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLdouble) + sizeof(GLdouble) + sizeof(GLint) + sizeof(GLint) + sizeof(GLdouble) * order * numValues << ID_LOG << 169;
LSSB(&target,GLenum); LSSB(&u1,GLdouble); LSSB(&u2,GLdouble); LSSB(&numValues,GLint); LSSB(&order,GLint); 
for(int i=0;i<order;i++) { 
	for(unsigned j=0;j<numValues;j++) { 
		LSSB(&points[j],GLdouble); 
	} 
	src += stride; 
}
ENDLOG
...
IF_LOGGING(170)
unsigned numValues = map_num_components(target); const GLfloat *src = points; //is modified stride now!!
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLint) + sizeof(GLint) + sizeof(GLfloat) * order * numValues << ID_LOG << 170;
LSSB(&target,GLenum); LSSB(&u1,GLfloat); LSSB(&u2,GLfloat); LSSB(&numValues,GLint); LSSB(&order,GLint);
for(int i=0;i<order;i++) { 
	for(unsigned j=0;j<numValues;j++) { 
		LSSB(&points[j],GLfloat); 
	} 
	src += stride; 
}
ENDLOG
...
IF_LOGGING(171)
unsigned numValues = map_num_components(target); const GLdouble *src = points; //is modified ustride now!!
GLint modvstride = ustride * uorder; //is modified vstride now!!
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLdouble) + sizeof(GLdouble) + sizeof(GLint) + sizeof(GLint) + sizeof(GLdouble) + sizeof(GLdouble) + sizeof(GLint) + sizeof(GLint) + sizeof(GLdouble) * uorder * vorder * numValues << ID_LOG << 171;
LSSB(&target,GLenum); LSSB(&u1,GLdouble); LSSB(&u2,GLdouble); LSSB(&numValues,GLint); LSSB(&uorder,GLint); LSSB(&v1,GLdouble); LSSB(&v2,GLdouble); LSSB(&modvstride,GLint); LSSB(&vorder,GLint);
...
IF_LOGGING(172)
unsigned numValues = map_num_components(target); const GLfloat *src = points; //is modified ustride now!!
GLint modvstride = ustride * uorder; //is modified vstride now!!
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLint) + sizeof(GLint) + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLint) + sizeof(GLint) + sizeof(GLfloat) * uorder * vorder * numValues << ID_LOG << 172;
LSSB(&target,GLenum); LSSB(&u1,GLfloat); LSSB(&u2,GLfloat); LSSB(&numValues,GLint); LSSB(&uorder,GLint); LSSB(&v1,GLfloat); LSSB(&v2,GLfloat); LSSB(&modvstride,GLint); LSSB(&vorder,GLint);
for(int v=0;v<vorder;v++) {
	for(int u=0;u<uorder;u++) {
		for(unsigned j=0;j<numValues;j++) { 
			LSSB(&points[j],GLfloat); 
...
IF_LOGGING(178)
if (pname == GL_SHININESS) { // one value
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLfloat) << ID_LOG << 177;
LSSB(&face,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); }
else if (pname == GL_COLOR_INDEXES) { // three values
GLfloat zero = 0;
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLfloat) * 4 << ID_LOG << 178;
LSSB(&face,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); LSSB(&params[1],GLfloat); LSSB(&params[2],GLfloat); LSSB(&zero,GLfloat); }
else { // four values
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLfloat) * 4 << ID_LOG << 178;
LSSB(&face,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); LSSB(&params[1],GLfloat); LSSB(&params[2],GLfloat); LSSB(&params[3],GLfloat); }
ENDLOG
...
if (pname == GL_SHININESS) { // one value
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLint) << ID_LOG << 179;
LSSB(&face,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLint); }
else if (pname == GL_COLOR_INDEXES) { // three values
GLfloat zero = 0;
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLint) * 4 << ID_LOG << 180;
LSSB(&face,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLint); LSSB(&params[1],GLint); LSSB(&params[2],GLint); LSSB(&zero,GLint); }
else { // four values
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLint) * 4 << ID_LOG << 180;
LSSB(&face,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLint); LSSB(&params[1],GLint); LSSB(&params[2],GLint); LSSB(&params[3],GLint); }
ENDLOG
...
IF_LOGGING(182)
LS << MAGIC << HEADERSIZE  + sizeof(GLdouble) * 16 << ID_LOG << 182;
for(int i=0;i<16;i++) { LSSB(&m[i],GLdouble); }
ENDLOG
...
IF_LOGGING(183)
LS << MAGIC << HEADERSIZE  + sizeof(GLfloat) * 16 << ID_LOG << 183;
for(int i=0;i<16;i++) { LSSB(&m[i],GLfloat); }
ENDLOG
...
IF_LOGGING(198)
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLsizei) + sizeof(GLfloat) * mapsize << ID_LOG << 198;
LSSB(&map,GLenum); LSSB(&mapsize,GLsizei); for(int i=0;i<mapsize;i++) { LSSB(&values[i],GLfloat); } 
ENDLOG
...
IF_LOGGING(199)
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLsizei) + sizeof(GLuint) * mapsize << ID_LOG << 199;
LSSB(&map,GLenum); LSSB(&mapsize,GLsizei); for(int i=0;i<mapsize;i++) { LSSB(&values[i],GLuint); }
ENDLOG
...
IF_LOGGING(200)
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLsizei) + sizeof(GLushort) * mapsize << ID_LOG << 200;
LSSB(&map,GLenum); LSSB(&mapsize,GLsizei); for(int i=0;i<mapsize;i++) { LSSB(&values[i],GLushort); }
ENDLOG
...
IF_LOGGING(209)
LS << MAGIC << HEADERSIZE  + sizeof(GLubyte) * 1024 << ID_LOG << 209;
for(int i=0;i<1024;i++) { LSSB(&mask[i],GLubyte); }
ENDLOG
...
IF_LOGGING(220)
LS << MAGIC << HEADERSIZE  + sizeof(GLdouble) + sizeof(GLdouble) << ID_LOG << 219;
LSSB(&v[0],GLdouble); LSSB(&v[1],GLdouble); 
ENDLOG
...
IF_LOGGING(222)
LS << MAGIC << HEADERSIZE  + sizeof(GLfloat) + sizeof(GLfloat) << ID_LOG << 221;
LSSB(&v[0],GLfloat); LSSB(&v[1],GLfloat); 
ENDLOG
...
IF_LOGGING(226)
LS << MAGIC << HEADERSIZE  + sizeof(GLshort) + sizeof(GLshort) << ID_LOG << 225;
LSSB(&v[0],GLshort); LSSB(&v[1],GLshort); 
ENDLOG
...
IF_LOGGING(246)
LS << MAGIC << HEADERSIZE  + sizeof(GLdouble) + sizeof(GLdouble) + sizeof(GLdouble) + sizeof(GLdouble) << ID_LOG << 245;
LSSB(&v1[0],GLdouble); LSSB(&v1[1],GLdouble); LSSB(&v2[0],GLdouble); LSSB(&v2[1],GLdouble);
ENDLOG
...
IF_LOGGING(248)
LS << MAGIC << HEADERSIZE  + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLfloat) + sizeof(GLfloat) << ID_LOG << 247;
LSSB(&v1[0],GLfloat); LSSB(&v1[1],GLfloat); LSSB(&v2[0],GLfloat); LSSB(&v2[1],GLfloat);
ENDLOG
...
IF_LOGGING(250)
LS << MAGIC << HEADERSIZE  + sizeof(GLint) + sizeof(GLint) + sizeof(GLint) + sizeof(GLint) << ID_LOG << 249;
LSSB(&v1[0],GLint); LSSB(&v1[1],GLint); LSSB(&v2[0],GLint); LSSB(&v2[1],GLint);
ENDLOG
...
IF_LOGGING(252)
LS << MAGIC << HEADERSIZE  + sizeof(GLshort) + sizeof(GLshort) + sizeof(GLshort) + sizeof(GLshort) << ID_LOG << 251;
LSSB(&v1[0],GLshort); LSSB(&v1[1],GLshort); LSSB(&v2[0],GLshort); LSSB(&v2[1],GLshort);
ENDLOG
...
IF_LOGGING(259)
LS << MAGIC << HEADERSIZE  + sizeof(GLsizei) + sizeof(GLuint) * size << ID_LOG << 259;
LSSB(&size,GLsizei); for(int i=0;i<size;i++) { LSSB(&buffer[i],GLuint); }
ENDLOG
...
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLfloat) << ID_LOG << 297;
LSSB(&target,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); }
else if (pname == GL_TEXTURE_ENV_COLOR) {
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLfloat) * 4 << ID_LOG << 298;
LSSB(&target,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); LSSB(&params[1],GLfloat); LSSB(&params[2],GLfloat); LSSB(&params[3],GLfloat); }
ENDLOG
...
if (pname == GL_TEXTURE_ENV_MODE) {
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLint) << ID_LOG << 299;
LSSB(&target,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLint); } 
else if (pname == GL_TEXTURE_ENV_COLOR) {
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLint) * 4 << ID_LOG << 300;
LSSB(&target,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLint); LSSB(&params[1],GLint); LSSB(&params[2],GLint); LSSB(&params[3],GLint); }
ENDLOG
...
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLdouble) << ID_LOG << 301;
LSSB(&coord,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLdouble); }
else if (pname == GL_OBJECT_PLANE || pname == GL_EYE_PLANE) {
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLdouble) * 4 << ID_LOG << 302;
LSSB(&coord,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLdouble); LSSB(&params[1],GLdouble); LSSB(&params[2],GLdouble); LSSB(&params[3],GLdouble); }
ENDLOG
...
if (pname == GL_TEXTURE_GEN_MODE) {
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLfloat) << ID_LOG << 303;
LSSB(&coord,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); }
else if (pname == GL_OBJECT_PLANE || pname == GL_EYE_PLANE) {
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLfloat) * 4 << ID_LOG << 304;
LSSB(&coord,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); LSSB(&params[1],GLfloat); LSSB(&params[2],GLfloat); LSSB(&params[3],GLfloat); }
ENDLOG
...
if (pname == GL_TEXTURE_GEN_MODE) {
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLint) << ID_LOG << 305;
LSSB(&coord,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLint); }
else if (pname == GL_OBJECT_PLANE || pname == GL_EYE_PLANE) {
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLint) * 4 << ID_LOG << 306;
LSSB(&coord,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLint); LSSB(&params[1],GLint); LSSB(&params[2],GLint); LSSB(&params[3],GLint); }
ENDLOG
...
IF_LOGGING(307)
unsigned bytes = crImageSize(format, type, width, 1); const GLbyte * bytePixels = (GLbyte*) pixels;
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLint) + sizeof(GLint) + sizeof(GLsizei) + sizeof(GLint) + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLbyte) * bytes << ID_LOG << 307;
LSSB(&target,GLenum); LSSB(&level,GLint); LSSB(&internalformat,GLint); LSSB(&width,GLsizei); LSSB(&border,GLint); LSSB(&format,GLenum); LSSB(&type,GLenum);
for(unsigned i=0;i<bytes;i++) { LSSB(&bytePixels[i],GLbyte); }
ENDLOG
...
IF_LOGGING(308)
unsigned bytes = crImageSize(format, type, width, height); const GLbyte * bytePixels = (GLbyte*) pixels;
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLint) + sizeof(GLint) + sizeof(GLsizei) + sizeof(GLsizei) + sizeof(GLint) + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLbyte) * bytes << ID_LOG << 308;
LSSB(&target,GLenum); LSSB(&level,GLint); LSSB(&internalformat,GLint); LSSB(&width,GLsizei); LSSB(&height,GLsizei); LSSB(&border,GLint); LSSB(&format,GLenum); LSSB(&type,GLenum);
for(unsigned i=0;i<bytes;i++) { LSSB(&bytePixels[i],GLbyte); }
ENDLOG
...
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLfloat) * 4 << ID_LOG << 310;
LSSB(&target,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLfloat); LSSB(&params[1],GLfloat); LSSB(&params[2],GLfloat); LSSB(&params[3],GLfloat); }
ENDLOG
...
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLint) * 4 << ID_LOG << 312;
LSSB(&target,GLenum); LSSB(&pname,GLenum); LSSB(&params[0],GLint); LSSB(&params[1],GLint); LSSB(&params[2],GLint); LSSB(&params[3],GLint); }
ENDLOG
...
IF_LOGGING(313)
unsigned bytes = crImageSize(format, type, width, 1); const GLbyte * bytePixels = (GLbyte*) pixels;
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLint) + sizeof(GLint) + sizeof(GLsizei) + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLbyte) * bytes << ID_LOG << 313;
LSSB(&target,GLenum); LSSB(&level,GLint); LSSB(&xoffset,GLint); LSSB(&width,GLsizei); LSSB(&format,GLenum); LSSB(&type,GLenum); 
for(unsigned i=0;i<bytes;i++) { LSSB(&bytePixels[i],GLbyte); }
ENDLOG
...
IF_LOGGING(314)
unsigned bytes = crImageSize(format, type, width, height); GLbyte * bytePixels = (GLbyte*) pixels;
LS << MAGIC << HEADERSIZE  + sizeof(GLenum) + sizeof(GLint) + sizeof(GLint) + sizeof(GLint) + sizeof(GLsizei) + sizeof(GLsizei) + sizeof(GLenum) + sizeof(GLenum) + sizeof(GLbyte) * bytes << ID_LOG << 314;
LSSB(&target,GLenum); LSSB(&level,GLint); LSSB(&xoffset,GLint); LSSB(&yoffset,GLint); LSSB(&width,GLsizei); LSSB(&height,GLsizei); LSSB(&format,GLenum); LSSB(&type,GLenum);
for(unsigned i=0;i<bytes;i++) { LSSB(&bytePixels[i],GLbyte); }
ENDLOG
